...
The decompression method for Envrionment basic data and spherical harmonic data is the same as described above, with the only thing to note being that the upper and lower limits of the interpolation values are the environmental data section of the attributes part in **Meta.lcc**.
...
If you need any assistance or would like to share your feedback, please let us know through our [Community](https://developer.xgrids.com/#/forum)
